...
I set eval=FALSE because somethin with the animation doesnt work in the Knitting process.
...
liverpool_plot <- ggplot(liverpool_standings, aes(x = season, y = points)) +
  geom_line(color = "darkred", size = 1.2) +
  geom_text(aes(label = position), size = 10) +
  labs(
    title = "Liverpool standings through the years",
    x = "Season",
    y = "Points"
  ) +
  transition_reveal(season) +
...
anim_save("liverpool.gif", animation = animate(liverpool_plot, width = 800, height = 500, fps = 10))
